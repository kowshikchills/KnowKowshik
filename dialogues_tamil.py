...
dialogues = {}
dialogues['reject'] = 'நான் பின்னர் பார்ப்பேன்'
dialogues['GREET1'] = {}

dialogues['GREET1']['text1'] = '<b> கவுஷிக்கிலிருந்து செய்தி: </b>\nஹாய், நான் க ow ஷிக் சிலம்குர்த்தி. உங்கள் மதிப்புமிக்க நேரத்தை எடுத்துக் கொண்டமைக்கும் எனது தனிப்பட்ட முகவர் / போட்டிற்கு செய்தி அனுப்பியமைக்கும் நன்றி. எனது தொழில்முறை பயணம் மற்றும் வாழ்க்கையைப் பற்றிய எனது பொதுவான பார்வை ஆகியவற்றைப் புரிந்துகொள்ள எனது நண்பன் உங்களுக்கு உதவும்.'

dialogues['GREET1']['text2'] = 'இப்போது நான் எனது நண்பரை இந்த உரையாடலை எடுத்துக் கொள்ள அனுமதிப்பேன்.\nகுறிப்பு: எனது நண்பன் சில நேரங்களில் அதிக நகைச்சுவையாக இருக்கலாம்! நீங்கள் இன்னும் என் பட்டிபாயுடன் தொடர்ந்து பேச விரும்புகிறீர்களா?'

dialogues['GREET1']['options'] =[['ஆம்'], ['இல்லை']]

dialogues['BYE'] = 'உங்கள் அருமையான நேரத்திற்கு நன்றி, மேலும் கேள்விகளுக்கு என்னை பிங் செய்யுங்கள் மற்றும் எந்த கேள்விகளுக்கும் kowshik: kowshikchilamkurthy@gmail.com க்கு மின்னஞ்சல் அனுப்புங்கள்.' 
dialogues['ERROR'] = 'கொடுக்கப்பட்ட விசைப்பலகையில் உள்ள பொத்தான்களை அழுத்தவும்'
dialogues['GREET2'] = {}
dialogues['GREET2']['text'] = 'நகைச்சுவையா? நானா? ஒருவர் இருக்கக்கூடிய அளவுக்கு நான் கண்ணியமாக இருக்கிறேன். எங்களைப் பற்றி போதும். உன்னைப் பற்றி ஏன் என்னிடம் சொல்லவில்லை. (* ppst உங்கள் எல்லா செய்திகளும் மிகவும் பாதுகாப்பானவை என்று உங்களுக்குச் சொல்ல நினைத்தேன்)' 

dialogues['GREET2']['options'] =[['நான் ஆட்சேர்ப்பு'], ['இதை நான் சரிபார்க்கிறேன்'], ['நான் ஒத்துழைப்பைத் தேடுகிறேன்'], ['நான் சொல்ல மாட்டேன்']]
dialogues['GREET3'] = {}
...
dialogues['GREET3'][dialogues['GREET2']['options'][0][0]]['text'] = 'வணக்கம் தேர்வாளர், நீங்கள் என்னிடம் க ow ஷிக் பற்றி மிகவும் குறிப்பிட்ட கேள்விகளைக் கேட்பதற்கு முன்.' 
dialogues['GREET3'][dialogues['GREET2']['options'][1][0]]['text'] = 'வணக்கம், உங்கள் ஆர்வத்திற்கு நன்றி. அவருடைய சுயவிவரத்தைப் பற்றி உங்களிடம் நிறைய கேள்விகள் இருப்பதை நான் அறிவேன், அதற்கு நான் விரைவில் பதிலளிப்பேன்.' 
dialogues['GREET3'][dialogues['GREET2']['options'][2][0]]['text'] = 'வணக்கம், உங்கள் ஆர்வத்திற்கு நன்றி. அவருடைய சுயவிவரத்தைப் பற்றி உங்களிடம் நிறைய கேள்விகள் இருப்பதை நான் அறிவேன், அதற்கு நான் விரைவில் பதிலளிப்பேன்.' 
dialogues['GREET3'][dialogues['GREET2']['options'][3][0]]['text'] = 'நான் நீங்கள் என்றால் நானும் அவ்வாறே செய்வேன். உங்கள் தனியுரிமை எந்த வகையிலும் மீறப்படவில்லை என்பதை உறுதிப்படுத்த நான் மிகவும் கவனமாக வடிவமைக்கப்பட்டேன் :)'
dialogues['GREET3']['text2'] = 'மிகவும் பொதுவான கேள்வியுடன் தொடங்குவேன்:\n க ow ஷிக் சிலம்குர்த்தி யார்?\n சரி, அவர் AI துறையில் ஒரு கடின உழைப்பாளி. அவர் எழுதுவதையும் தொழில்நுட்பத்தையும் விரும்புகிறார், அவர் என்னை உருவாக்கியதற்கு ஒரு காரணம். அவர் மதிப்புமிக்க ஐ.ஐ.டி மெட்ராஸில் பட்டம் பெற்றார், தற்போது அல்காரிதமிக் வர்த்தகத்தில் தரவு விஞ்ஞானியாக வலுவூட்டல் சாய்வில் பணியாற்றி வருகிறார். நான் நாள் முழுவதும் க ow ஷிக் பற்றி பேச முடியும். ஆனாலும்'
dialogues['GREET3']['text3'] = 'க ஷிக் சிலம்குர்த்தியைப் பற்றி மேலும் அறிய விரும்புகிறீர்களா?'
dialogues['GREET3']['options'] = [['ஆம்'],[dialogues['reject']]]

dialogues['PROCESS'] = {}
dialogues['PROCESS']['text'] = 'அவரைப் பற்றி நீங்கள் தெரிந்து கொள்ள விரும்புவது என்ன? உங்கள் கேள்விகளுக்கு பதிலளிக்க விரும்புகிறேன்'
dialogues['PROCESS']['options'] =[['அவரது சி.வி.'], ['Can you point me to his writings?'], ['Would love to understand his professional journey'], ['Want to know him more than his CV']]
